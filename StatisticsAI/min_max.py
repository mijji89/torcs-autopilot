...
df = pd.read_csv("ProgettoIA\Torc\classes\datasetAndre.csv", delimiter=';')
df1 = pd.read_csv("ProgettoIA\Torc\classes\datasetMic.csv", delimiter=';')
df3 = pd.read_csv("ProgettoIA\Torc\classes\datasetBet.csv", delimiter=';')
df4 = pd.read_csv("ProgettoIA\Torc\classes\datasetReb.csv", delimiter=';')
df5 = pd.read_csv("ProgettoIA\Torc\classes\datasetManovre.csv", delimiter=';')
